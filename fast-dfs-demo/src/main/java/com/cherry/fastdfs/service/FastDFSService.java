 ...
 * @Date: 2021/3/20
 * @Desc: FastDFSSerivce
 * 链接地址：https://mp.weixin.qq.com/s/nzJ8uvHTeio0qK9fYYvehQ
 */
@Service
public class FastDFSService {
    ...
    public void setFastDFSClient(FastFileStorageClient fastFileStorageClient, FdfsWebServer fdfsWebServer) {
        FastDFSService.fastFileStorageClient = fastFileStorageClient;
        FastDFSService.fdfsWebServer = fdfsWebServer;
    }
